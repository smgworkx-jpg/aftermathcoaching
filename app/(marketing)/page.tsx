    ...
    <section className="relative overflow-hidden px-5 pb-24 pt-40 lg:px-8 lg:pb-32 lg:pt-52">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-[1.08fr_.92fr]">
        <div className="relative z-10">
          ...
          <div className="reveal delay-3 mt-9 flex flex-wrap gap-3"><Link className="clip-button flex items-center gap-3 bg-violet-500 px-7 py-4 text-sm font-bold uppercase tracking-[.14em] text-white shadow-[0_0_45px_rgba(139,92,246,.25)]" href="/signup">Start your transformation <ArrowRight size={17}/></Link><Link className="clip-button border border-white/10 bg-white/[.03] px-7 py-4 text-sm font-bold uppercase tracking-[.14em] text-white" href="/#platform">Explore platform</Link></div>
